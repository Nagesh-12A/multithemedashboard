...
function Profile() {
  return (
    <Box sx={{height:'100vh', py: 10, display: "flex", flexDirection: "column", alignItems: "center"  }}>
      <Container maxWidth={false} sx={{ position: "relative", display: "flex", alignItems: "center",justifyContent:'center' }}>
    ...
    >
      {/* Left Content */}
      <Grid  spacing={3} justifyContent="center"  sx={{ textAlign: { xs: "center", md: "left" }, flex: 1,width:'100%', marginLeft:'40px',textalign: "center",
        margin: "auto",
        justifycontent: "center", }}>
        <Typography variant="h4" fontWeight="bold" fontFamily="Rubik" style={{ color: "black" }}>
          Hello, <br /> I am <span>Nagesh Vandana.</span>
        </Typography>
        <Typography variant="h6" sx={{ color: "#E2A36C", fontWeight: "bold", mt: 1,fontFamily:"Rubik" }}>
          Frontend Developer
        </Typography>
        <Typography variant="body1" color="text.secondary" sx={{ mt: 2,fontFamily:"Rubik" }}>
