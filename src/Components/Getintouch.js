    ...
    <Box sx={{ py: 6, px: 3 }}>
      <Grid container spacing={4} justifyContent="center">
        ...
        <Grid item xs={12} md={5}>
          <Typography variant="h4" fontWeight="bold" sx={{marginTop:'70px',fontFamily:"Rubik"}}>
            Need a quote for a project? Get in touch...
          </Typography>
          <Typography variant="body1" sx={{ mt: 2,fontFamily:"Rubik" }}>
            <strong>
          ...
          <Box sx={{ display: "flex", gap: 2, mt: 5}}>
              <a href="https://github.com/Nagesh-12A?tab=repositories"><GitHubIcon 
              style={{ 
                fill: "orange",
                  // backgroundColor: "#fff"
                 }}/></a>
              ...
              <a href="https://x.com/home"><XIcon  style={{ 
                fill: "orange",
                  // backgroundColor: "#fff"
                 }}/></a>
        ...
        <Grid item xs={12} md={5}>
          <Box component="form" sx={{ display: "flex", flexDirection: "column", gap: 2}}>
            ...
            <TextField
              ...
              variant="outlined"
              fullWidth
              sx={{ background: "white",borderRadius:'10px',fontFamily:"Rubik"}}
            >
            ...
            />
            <Button variant="contained" sx={{ background: "#FF4C61", color: "white", mt: 2 ,borderRadius:'10px',fontFamily:"Rubik"}}>
              Submit
            </Button>
          </Box>
        </Grid>
      ...
      <Box sx={{ backgroundColor: "#FF4C61", color: "white", py: 4, mt: 6, textAlign: "center", borderRadius:'20px' }}>
        <Grid container spacing={3} justifyContent="center">
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography sx={{mt:'2',fontFamily:"Rubik"}}>Email: <a href="mailto:vandananagesh2001@gmail.com">vandananagesh2001@gmail.com</a></Typography>
            <Typography sx={{mt:'5',fontFamily:"Rubik"}}>Phone:  <a href="tel:+91-7729884738"> +91-7729884738 </a></Typography>
          </Grid>

          {/* Middle - Social Media */}
          <Grid item xs={12} md={4}>
            <Typography variant="h5" fontWeight="bold" fontFamily="Rubik">Social Media</Typography>
            <Box sx={{ color:"white", display: "flex", justifyContent: "center", gap: 2, mt: 1 }}>
          ...
          {/* Right - Address */}
          <Grid item xs={12} md={4}>
            <Typography variant="h5" fontWeight="bold" fontFamily="Rubik">Where we are</Typography>
            <Typography fontFamily="Rubik">India</Typography>
            <Typography fontFamily="Rubik">Hyderabad</Typography> 
          </Grid>
        </Grid>
      </Box>
    </Box>
