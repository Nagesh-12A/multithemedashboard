  ...
  return (
    <Box sx={{  minHeight: "100vh", display: "flex", alignItems: "center",
      ...
      <Container maxWidth={false} sx={{ display: "flex", justifyContent: "space-between", alignItems: "center",  px: 5 }}>
        {/* Left Content */}
        <Grid item xs={12} sm={12} md={7} sx={{ width:'100%', marginLeft:'38px' }}>
          <Typography  variant="h3" fontWeight="bold" fontFamily= "Rubik" gutterBottom>
          We have <br/> experience in web development.
          </Typography>
          <Typography variant="body1"  fontFamily= "Rubik" mb={3}>
          <strong>Hi! I'm a Frontend and Backend Developer Creating bold and innovative interface designs.</strong>
          </Typography>
          <Box display="flex" gap={2}>
            <Button variant="contained" sx={{ backgroundColor: "#8a7aff", color: "white",fontFamily:"Rubik" }}
             href="mailto:vandananagesh2001@gmail.com">Let's Talk
            </Button>
            <Button variant="text" fontFamily= "Rubik" href="http://nageshvandana.42web.io/?i=1">Portfolio</Button>
          </Box>
