    ...
    <>
      ...
      > */}
        ...
        >
                  ...
                  >
                    <CardHeader
                      ...
                      title={
                        <>
                          <Typography
                            sx={{ color: "white", fontSize: "30px",fontFamily:"Rubik" }}
                            variant="caption"
                          >
                            {item.Ammount}
                          </Typography>
                          <Typography
                            sx={{ color: "white", fontSize: "20px", fontFamily:"Rubik" }}
                            variant="caption"
                          >
                            {item.Percentage}
                          </Typography>
                      ...
                      subheader={
                        <Typography sx={{ color: "white", fontFamily:"Rubik" }} variant="caption">
                          {item.text}
                        </Typography>
                      }
                    />
            ...
            <Box sx={{ width: "100%", mb: "15px" }}>
              ...
              >
                <Grid size={{ xs: 12, sm: 12, md: 6 }}>
                  <Typography variant="h6" color="white" fontFamily="Rubik">
                    Social Media [LinkedIn && Naukri]
                  </Typography>
                  <Typography variant="h6" color="gray" fontFamily="Rubik">
                    January-March 2025
                  </Typography>
                </Grid>
                <Grid size={{ xs: 12, sm: 12, md: 6 }}>
            ...
            <Grid container spacing={2}>
              {services.map((service, index) => (
                <Grid size={{ xs: 12, sm: 12, md: 4 }} key={index}>
                  <Card>
                    <CardMedia
                      sx={{ borderRadius: "17px",fontFamily:"Rubik" }}
                      component="img"
                      height="180px"
                      image={service.image}
                      alt={service.title}
                    ...
                    >
                      <Grid container spacing={4}>
                        <Grid size={{ xs: 5, sm: 5, md: 5 }}>
                          <Typography
                            variant="h5"
                            sx={{ textAlign: "center", color: "white", fontFamily:"Rubik" }}
                          >
                            {service.Frinds}
                          </Typography>
                          <Typography
                            variant="body1"
                            sx={{ textAlign: "center", color: "whitesmoke",fontFamily:"Rubik" }}
                          >
                            {service.follows}
                          </Typography>
                        </Grid>
                        ...
                        <Divider
                          ...
                          flexItem
                          sx={{ background: "red",width:'3px',fontFamily:"Rubik" }}
                        />
          ...
          >
            <Typography variant="h5" sx={{color:"whitesmoke",fontFamily:"Rubik" }}>
                      ...
                      >
                        <Grid item size={{ xs: 2, sm: 2, md: 2 }}>
                          <Typography
                            ...
                            // sx={{ marginLeft: "50px" }}
                          >
                            <Typography fontFamily="Rubik">{day.label}</Typography>
                          </Typography>
                        </Grid>
                    ...
                    >
                      ...
                      >
                        <Grid item size={{ xs: 12, sm: 12, md: 6 }}>
                          <Typography fontFamily="Rubik">{demographics.label}</Typography>
                        </Grid>
                        <Grid item size={{ xs: 12, sm: 12, md: 6 }}>
                          <Typography style={{ textAlign: "right",fontFamily:"Rubik" }}>
                            {demographics.value}
                          </Typography>
                        </Grid>
                      </Grid>
                ...
                >
                  {datas.sources.map((source, index) => (
                    ...
                    >
                      ...
                      >
                        <Grid item size={{ xs: 12, sm: 12, md: 6 }}>
                          <Typography fontFamily="Rubik">{source.label}</Typography>
                        </Grid>
                        <Grid item size={{ xs: 12, sm: 12, md: 6 }}>
                          <Typography style={{ textAlign: "right",fontFamily:"Rubik" }}>
                            {source.value}
                ...
                <TableContainer sx={{ p: 2 }}>
                  <Table>
                    <TableHead>
                      <TableRow>
                        <TableCell>
                          <Typography style={{ fontWeight: "bold",fontFamily:"Rubik" }}>LinkedIn Users</Typography>
                        </TableCell>
                        <TableCell
                          
                        >
                        <Typography style={{ fontWeight: "bold",fontFamily:"Rubik" }}>Country</Typography>
                        </TableCell>
                        <TableCell
                  
                        >
                        <Typography style={{ fontWeight: "bold",fontFamily:"Rubik" }}>Usage</Typography>
                        </TableCell>
                        <TableCell
                         
                        >
                         <Typography style={{ fontWeight: "bold",fontFamily:"Rubik" }}>Paymet Method</Typography>
                        </TableCell>
                        <TableCell
                        
                        >
                        <Typography style={{ fontWeight: "bold",fontFamily:"Rubik" }}>Activity</Typography> 
                        </TableCell>
                      </TableRow>
                    </TableHead>
                    <TableBody>
                        ...
                        <TableRow key={index}>
                          <TableCell>
                            <Box display="flex" alignItems="center">
                              ...
                              />
                              <Box sx={{ color: "white" }}>
                                <Typography fontFamily="Rubik">{user.name}</Typography>
                                <Typography variant="body2" color="gray" fontFamily="Rubik">
                                  {user.status}
                                </Typography>
                              </Box>
                            </Box>
                          ...
                          <TableCell>
                            <Box display="flex" alignItems="center">
                              <Typography
                                sx={{ mr: 2, color: "white",fontFamilyy:"Rubik" }}
                          ...
                          <TableCell>
                            <Box sx={{ color: "gray" }}>
                              <Typography fontFamily="Rubik">{user.Login}</Typography>
                              <Typography variant="body2" color="white" fontFamily="Rubik">
                                {user.activity}
                              </Typography>
                            </Box>
                          </TableCell>
      ...
      <Box sx={{backgroundColor:'whitesmoke',padding:'5px',width:'700px'}}>
      <Typography sx={{fontFamily:"Rubik", marginLeft:'20px'}}><a href="mailto:vandananagesh2001@gmail.com">vandananagesh2001@gmail.com</a></Typography> 
      </Box>
    </Stack> */}
              </Box>
            </Grid>
...
const usersData = [
  ...
  {
    avatar:
      "https://media.licdn.com/dms/image/v2/D5635AQEahxUUeE2Jog/profile-framedphoto-shrink_800_800/profile-framedphoto-shrink_800_800/0/1714628118549?e=1741960800&v=beta&t=kfgiPrJUmabL_yoirdSjFU9HMFsAPsTFI60TL79Sb_U",
    name: "M Yugandhra",
  ...
  {
    avatar:
      "https://media.licdn.com/dms/image/v2/D5635AQGbDV68qjkPiw/profile-framedphoto-shrink_800_800/profile-framedphoto-shrink_800_800/0/1707716959787?e=1741960800&v=beta&t=g0R1B8uW-ez_rVwUZwkIAUxD14MzVGcsYreyNKCYKHk",
    name: "B Venkatesh",
    status: "New | Registered: Jan 1, 2023",
    country: "INDIA",
